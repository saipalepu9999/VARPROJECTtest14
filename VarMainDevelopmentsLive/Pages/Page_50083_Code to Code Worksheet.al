page 50083 "Code to Code Worksheet"
{
    // version C2C
    Caption = 'Stock Transfer(Domestic To Eou)';
    DelayedInsert = true;
    PageType = Worksheet;
            ...
            group("F&unctions")
            {
                ...
                group(Items)
                {
                    ...
                    action("Get Batches")
                    {
                        ...
                        trigger OnAction();
                        begin
                            Rec.SuggestRetestItems(FromItemNo);
                        end;
                    }
    ...
    begin
        if ItemLrec.Get(FromItemNo) and (ItemLrec."Global Dimension 1 Code" <> 'DOM') then
            Error('You cannot select this item');
