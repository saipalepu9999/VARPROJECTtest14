page 50015 "MRV List"
{
    ...
    Caption = 'PO List-(Ready For Materials MRV)';
    CardPageID = "MRV Document";
    DataCaptionFields = "Buy-from Vendor No.";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Request Approval,Print/Send,Order,Release,Posting,Navigate';
    QueryCategory = 'MRV List';
    RefreshOnActivate = true;
    SourceTable = "Purchase Header";
    SourceTableView = WHERE("Document Type" = CONST(Order), Status = filter(Released | "Pending Prepayment"), "Service MRV" = const(false));
    UsageCategory = Lists;
    layout
    {
        area(content)
