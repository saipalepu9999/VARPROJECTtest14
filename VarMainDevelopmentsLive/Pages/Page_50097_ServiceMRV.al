page 50097 "Service MRV"
{
    ...
    InsertAllowed = false;
    DeleteAllowed = false;
    SourceTableView = WHERE("Document Type" = FILTER(Order), "Service MRV" = const(true));
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "Service MRV Subform")
            {
                ApplicationArea = Suite;
                Caption = 'Service MRV Lines';
