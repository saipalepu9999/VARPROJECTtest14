page 50059 "Transfer Orders Job Work"
{
    ApplicationArea = Location;
    Caption = 'Transfer Order List - Internal MRS';
    CardPageID = "Transfer Order Job Work";
    Editable = false;
    PageType = List;
    SourceTable = "Transfer Header";
    UsageCategory = Lists;
    SourceTableView = where("Created From MRS" = const(true));
