page 50071 "Enter Customized SN&Lot"
{
    ...
    procedure GetFieldsNew(var GetQtyToCreate: Integer; var GetCreateNewLotNo: Boolean; var GetCustomizedSN: Code[50]; var GetIncrement: Integer; var GetCreateSNInfo: Boolean; var LotNoPar: Code[20])
    begin
        GetQtyToCreate := QtyToCreate;
        GetCreateNewLotNo := CreateNewLotNo;
        GetCustomizedSN := CustomizedSN;
