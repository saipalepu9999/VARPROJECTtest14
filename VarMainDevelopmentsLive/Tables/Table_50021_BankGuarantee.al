table 50021 "Bank Guarantee"
{
    Caption = 'Bank Account';
    DataCaptionFields = "BG No.", Name;
    ...
    fields
    {
        field(1; "BG No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                if "BG No." <> xRec."BG No." then begin
                    GLSetup.Get();
        ...
        field(22; "Currency Code"; Code[10])
        {
            ...
            begin
                ...
                BankAccLedgEntry.SetRange("Bank Account No.", "BG No.");
        ...
        field(58; Balance; Decimal)
        {
            ...
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
            CalcFormula = Sum("Bank Account Ledger Entry".Amount WHERE("Bank Account No." = FIELD("BG No."),
        ...
        field(59; "Balance (LCY)"; Decimal)
        {
            AccessByPermission = TableData "Bank Account Ledger Entry" = R;
            AutoFormatType = 1;
            CalcFormula = Sum("Bank Account Ledger Entry"."Amount (LCY)" WHERE("Bank Account No." = FIELD("BG No."),
                                                                                "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter")));
            Caption = 'Balance (LCY)';
            Editable = false;
        ...
        field(62; "Total on Checks"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
            CalcFormula = Sum("Check Ledger Entry".Amount WHERE("Bank Account No." = FIELD("BG No."),
        ...
        field(97; "Debit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Debit Amount" WHERE("Bank Account No." = FIELD("BG No."),
                                                                                "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                "Posting Date" = FIELD("Date Filter")));
        ...
        field(98; "Credit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Credit Amount" WHERE("Bank Account No." = FIELD("BG No."),
                                                                                 "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                 "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                 "Posting Date" = FIELD("Date Filter")));
        ...
        field(99; "Debit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Debit Amount (LCY)" WHERE("Bank Account No." = FIELD("BG No."),
                                                                                      "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                      "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                      "Posting Date" = FIELD("Date Filter")));
        ...
        field(100; "Credit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Credit Amount (LCY)" WHERE("Bank Account No." = FIELD("BG No."),
                                                                                       "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                       "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                       "Posting Date" = FIELD("Date Filter")));
        ...
        field(50000; "Issuing Bank / Receiving Bank"; text[30])
        {
        ...
        field(50002; "Date Of Issue"; Date)
        {
            DataClassification = ToBeClassified;
        ...
        field(50004; "Claim Date"; Date)
        {
            DataClassification = ToBeClassified;
            Caption = 'Claim date';
        }
        field(50005; "Type Of BG"; Option)
        {
            DataClassification = ToBeClassified;
            Caption = 'Type Of BG';
            OptionMembers = ,Security,Performance,Advance,FIM,"Performance & Security";
            OptionCaption = ' ,Security,Performance,Advance,FIM,Performance & Security';
        }
        field(50006; "BG Value"; Decimal)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Value';
        }
        ...
        field(50008; "BG Margin Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Margin Amount';
        }
        field(50009; "Security Deposit No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Security Deposit No.';
        }
        field(50010; "BG Posting status"; Option)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Posting Status';
            OptionMembers = ,Purchased,Surrendered;
            OptionCaption = ',Purchased,Surrendered';
        }
        field(50011; Extended; Option)
        {
            DataClassification = ToBeClassified;
            Caption = 'Extended';
            OptionMembers = ,Amount,Date,Both;
            OptionCaption = ' ,Amount,Date,Both';
        }
        field(50012; "Bank BG No"; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Bank BG No';

        }
        field(50013; "BG Renewal Date"; Date)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Renewal Date';

        }
        field(50014; "Account Type"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(50015; "Account No"; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Account No.';
        ...
        field(50016; "Bal.Account Type"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(50018; "Date Of issued"; Date)
        {
            DataClassification = ToBeClassified;
            Caption = 'Date Of Issued';
        }
        field(50019; "Extended Date"; date)
        {
            DataClassification = ToBeClassified;
            Caption = 'Extended Date';
        }
        field(50020; "BG Status"; Option)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Status';
            OptionMembers = Open,Close,Surrendered;
            OptionCaption = 'Open,Close,Surrendered';
        }
        field(50021; "Extension Ref No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Extension Ref No.';
        }
        field(50022; "BG Date"; Date)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Date';
        }//B2BPR16Dec2022
        field(50023; "Customer/Vendor"; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Customer/Vendor';
            TableRelation = if ("Transaction Type" = const(Sales)) Customer else
            if ("Transaction Type" = const(Purchase)) Vendor;
            trigger OnValidate()
            var
                CustomerGrec: Record Customer;
                VendorGrac: Record Vendor;
            begin
                if CustomerGrec.Get("Customer/Vendor") then begin
                    Address := CustomerGrec.Address;
                    "Address 2" := CustomerGrec."Address 2";
                    "Post Code" := CustomerGrec."Post Code";
                    City := CustomerGrec.City;
                    "Country/Region Code" := CustomerGrec."Country/Region Code";
                    "Phone No." := CustomerGrec."Phone No.";
                    "Mobile Phone No." := CustomerGrec."Mobile Phone No.";
                    Contact := CustomerGrec.Contact;
                    "E-Mail" := CustomerGrec."E-Mail";
                    "Home Page" := CustomerGrec."Home Page";

                    if VendorGrac.Get("Customer/Vendor") then begin
                        Address := VendorGrac.Address;
                        "Address 2" := VendorGrac."Address 2";
                        "Post Code" := VendorGrac."Post Code";
                        City := VendorGrac.City;
                        "Country/Region Code" := VendorGrac."Country/Region Code";
                        "Phone No." := VendorGrac."Phone No.";
                        "Mobile Phone No." := VendorGrac."Mobile Phone No.";
                        Contact := VendorGrac.Contact;
                        "E-Mail" := VendorGrac."E-Mail";
                        "Home Page" := VendorGrac."Home Page";
                    end;
                end;
            end;
        }//B2BPR16Dec2022
        field(50024; "Cancelation Date"; Date)
        {
            DataClassification = ToBeClassified;
            Caption = 'Cancelation Date';
            trigger OnValidate()
            begin
                if (Rec."Cancelation Date" <> 0D) then
                    Rec."BG Status" := Rec."BG Status"::Close
                else
                    Rec."BG Status" := Rec."BG Status"::Open;
            end;
        }
        //B2BPROn24JUN2023<<<
        field(50025; "Bank Name"; Text[50])
        {
            DataClassification = ToBeClassified;
            Caption = 'Bank Name';
        }
        field(50026; "BG Received Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Received Amount';
        }
        field(50027; "BG Intrest"; Decimal)
        {
            DataClassification = ToBeClassified;
            Caption = 'BG Intrest';
        }
        field(50028; "TDS Receivable Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
            Caption = 'TDS Receivable Amount';
        }
        //B2BPROn24JUN2023<<<
    }
    keys
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "BG No.", Name, "Bank Account No.", "Currency Code")
        {
        }
        fieldgroup(Brick; "BG No.", Name, "Bank Account No.", "Currency Code", Image)
        {
        }
    }
    ...
    begin
        ...
        CommentLine.SetRange("No.", "BG No.");
        CommentLine.DeleteAll();

        //UpdateContFromBank.OnDelete(Rec);

        DimMgt.DeleteDefaultDim(DATABASE::"Bank Account", "BG No.");
    end;
    ...
    begin
        if "BG No." = '' then begin
            ...
            NoSeriesMgt.InitSeries(GLSetup."Bank Account Nos.", xRec."No. Series", 0D, "BG No.", "No. Series");
        end;
    ...
    trigger OnRename()
    begin
        DimMgt.RenameDefaultDim(DATABASE::"Bank Account", xRec."BG No.", "BG No.");
        CommentLine.RenameCommentLine(CommentLine."Table Name"::"Bank Account", xRec."BG No.", "BG No.");
        "Last Date Modified" := Today;
    end;
    ...
    procedure AssistEdit(OldBankAcc: Record "Bank Guarantee"): Boolean
    begin
        BankAcc := Rec;
        GLSetup.Get();
        GLSetup.TestField("Bank Account Nos.");
        if NoSeriesMgt.SelectSeries(GLSetup."Bank Account Nos.", OldBankAcc."No. Series", BankAcc."No. Series") then begin
            GLSetup.Get();
            GLSetup.TestField("Bank Account Nos.");
            NoSeriesMgt.SetSeries(BankAcc."BG No.");
            Rec := BankAcc;
            exit(true);
        end;
    end;
    ...
    begin
        ...
        if not IsTemporary then begin
            DimMgt.SaveDefaultDim(DATABASE::"Bank Account", "BG No.", FieldNumber, ShortcutDimCode);
            Modify;
        end;
    ...
    begin
        ...
        //ContBusRel.SetCurrentKey("Link to Table", "BG No.");
        ContBusRel.SetRange("Link to Table", ContBusRel."Link to Table"::"Bank Account");
        ContBusRel.SetRange("No.", "BG No.");
        if not ContBusRel.FindFirst() then begin
            if not Confirm(Text003, false, TableCaption, "BG No.") then
                exit;
    ...
    begin
        ...
        PaymentRegistrationSetup.SetRange("Bal. Account No.", "BG No.");
    ...
    begin
        ...
        if not UpdateNeeded and not IsTemporary then
            UpdateNeeded := BankContUpdate.ContactNameIsBlank("BG No.");
