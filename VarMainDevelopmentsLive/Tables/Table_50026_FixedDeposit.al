table 50026 "Fixed Deposit_B2B"
{
    Caption = 'Fixed Deposit';
    DataCaptionFields = "FD No.", Name;
    DrillDownPageID = FixedDepositList;
    LookupPageID = FixedDepositList;
    ...
    fields
    {
        field(1; "FD No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                if "FD No." <> xRec."FD No." then begin
                    GLSetup.Get();
        ...
        field(22; "Currency Code"; Code[10])
        {
            ...
            begin
                ...
                BankAccLedgEntry.SetRange("Bank Account No.", "FD No.");
        ...
        field(58; Balance; Decimal)
        {
            ...
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
            CalcFormula = Sum("Bank Account Ledger Entry".Amount WHERE("Bank Account No." = FIELD("FD No."),
        ...
        field(59; "Balance (LCY)"; Decimal)
        {
            AccessByPermission = TableData "Bank Account Ledger Entry" = R;
            AutoFormatType = 1;
            CalcFormula = Sum("Bank Account Ledger Entry"."Amount (LCY)" WHERE("Bank Account No." = FIELD("FD No."),
                                                                                "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter")));
            Caption = 'Balance (LCY)';
            Editable = false;
        ...
        field(62; "Total on Checks"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
            CalcFormula = Sum("Check Ledger Entry".Amount WHERE("Bank Account No." = FIELD("FD No."),
        ...
        field(97; "Debit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Debit Amount" WHERE("Bank Account No." = FIELD("FD No."),
                                                                                "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                "Posting Date" = FIELD("Date Filter")));
        ...
        field(98; "Credit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Credit Amount" WHERE("Bank Account No." = FIELD("FD No."),
                                                                                 "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                 "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                 "Posting Date" = FIELD("Date Filter")));
        ...
        field(99; "Debit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Debit Amount (LCY)" WHERE("Bank Account No." = FIELD("FD No."),
                                                                                      "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                      "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                      "Posting Date" = FIELD("Date Filter")));
        ...
        field(100; "Credit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Bank Account Ledger Entry"."Credit Amount (LCY)" WHERE("Bank Account No." = FIELD("FD No."),
                                                                                       "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                       "Global Dimension 2 Code" = FIELD("Global Dimension 2 Filter"),
                                                                                       "Posting Date" = FIELD("Date Filter")));
        ...
        field(50000; "FD Document No."; Code[20])
        {
            Caption = 'FD Document No.';
            DataClassification = ToBeClassified;
        }
        field(50001; "FD Date"; Date)
        {
            Caption = 'FD Date';
            DataClassification = ToBeClassified;
        }
        field(50002; "FD Type"; Option)
        {
            Caption = 'FD Type';
            DataClassification = ToBeClassified;
            //OptionMembers = ,New,Renewal;
            //OptionCaption = ' ,New,Renewal';
            OptionMembers = ,Term,Fixed;
            OptionCaption = ' ,Term,Fixed';//B2BPROn24JUN2023<<<
        }
        field(50003; "FD Amount"; Decimal)
        {
            Caption = 'FD Amount';
            DataClassification = ToBeClassified;
        }
        ...
        field(50005; "Maturity Value"; Decimal)
        {
        ...
        field(50007; "Account No"; Code[20])
        {
            Caption = 'Account No';
            DataClassification = ToBeClassified;
            TableRelation = IF ("Account Type" = CONST(Bank)) "Bank Account";
        }
        field(50008; "Posting Fd No"; Code[20])
        {
            Caption = 'Posting Fd No';
            DataClassification = ToBeClassified;
        }
        field(50009; "Fixed Deposit Period"; Option)
        {
            Caption = 'Fixed Deposit Period';
            DataClassification = ToBeClassified;
            OptionMembers = Day,Monthly,Yearly;
            OptionCaption = 'Day,Monthly,Yearly';
        }
        field(50010; Frequency; Option)
        {
            Caption = 'Frequency';
            DataClassification = ToBeClassified;
            OptionMembers = SimpleInterest,Monthly,Quarterly,Halfyearly,Annually;
            OptionCaption = 'SimpleInterest,Monthly,Quarterly,Halfyearly,Annually';
        }
        field(50011; "FD Profile"; Code[20])
        {
            Caption = 'FD Profile';
            DataClassification = ToBeClassified;
        }
        field(50012; "FD Create Template Name"; Code[10])
        {
            Caption = 'FD Create Template Name';
            DataClassification = ToBeClassified;
        }
        field(50013; "FD Create Batch Name"; Code[10])
        {
            Caption = 'FD Create Batch Name';
            DataClassification = ToBeClassified;
        }
        field(50014; "BG Transfer"; Boolean)
        {
            Caption = 'BG Transfer';
            DataClassification = ToBeClassified;
        }
        field(50015; "BG No"; Code[20])
        {
            Caption = 'BG No';
            DataClassification = ToBeClassified;
        }
        field(50016; "BG Vend/Cust"; Code[20])
        {
            Caption = 'BG Vend/Cust';
            DataClassification = ToBeClassified;
        }
        field(50017; "BG Vend/Cust Name"; Text[50])
        {
            Caption = 'BG Vend/Cust Name';
            DataClassification = ToBeClassified;
        }
        field(50018; "BG Starting Date"; Date)
        {
            Caption = 'BG Starting Date';
            DataClassification = ToBeClassified;
        }
        field(50019; "BG Ending Date"; Date)
        {
            Caption = 'BG Ending Date';
            DataClassification = ToBeClassified;
        }
        field(50020; "BG Claim Date"; Date)
        {
            Caption = 'BG Claim Date';
            DataClassification = ToBeClassified;
        }
        field(50021; "BG Description"; Text[100])
        {
            Caption = 'BG Description';
            DataClassification = ToBeClassified;
        }
        field(50022; "BG Amount"; Decimal)
        {
            Caption = 'BG Amount';
            DataClassification = ToBeClassified;
        }
        field(50023; "BG Type"; Option)
        {
            Caption = 'BG Type';
            DataClassification = ToBeClassified;
        ...
        field(50024; "FD Amnt After Deductions"; Decimal)
        {
            Caption = 'FD Amnt After Deductions';
            DataClassification = ToBeClassified;
        }
        field(50025; "FD Narration"; Text[250])
        {
            Caption = 'FD Narration';
            DataClassification = ToBeClassified;
        }
        //B2BPROn24JUN2023<<<
        field(50026; Status; Option)
        {
            DataClassification = ToBeClassified;
            Caption = 'Status';
            OptionMembers = Open,Released,Close;
            OptionCaption = 'Open,Released,Close';
        }
        field(50027; "FD Intrest Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
            Caption = 'FD Intrest Amount';
        }
        ...
        //B2BPROn24JUN2023<<<
        field(50029; "Account No.1"; Text[100])
        {
            DataClassification = ToBeClassified;
            Caption = 'Account No.';
        }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "FD No.", Name, "Bank Account No.", "Currency Code")
        {
        }
        fieldgroup(Brick; "FD No.", Name, "Bank Account No.", "Currency Code", Image)
        {
        }
    }
    ...
    begin
        ...
        CommentLine.SetRange("No.", "FD No.");
        CommentLine.DeleteAll();

        //UpdateContFromBank.OnDelete(Rec);

        DimMgt.DeleteDefaultDim(DATABASE::"Bank Account", "FD No.");
    end;
    ...
    begin
        if "FD No." = '' then begin
            ...
            NoSeriesMgt.InitSeries(GLSetup."Bank Account Nos.", xRec."No. Series", 0D, "FD No.", "No. Series");
        end;
    ...
    trigger OnRename()
    begin
        DimMgt.RenameDefaultDim(DATABASE::"Bank Account", xRec."FD No.", "FD No.");
        CommentLine.RenameCommentLine(CommentLine."Table Name"::"Bank Account", xRec."FD No.", "FD No.");
        "Last Date Modified" := Today;
    end;
    ...
    var
        ...
        BankAcc: Record "Fixed Deposit_B2B";
    ...
    procedure AssistEdit(OldBankAcc: Record "Fixed Deposit_B2B"): Boolean
    begin
        BankAcc := Rec;
        GLSetup.Get();
        GLSetup.TestField("Bank Account Nos.");
        if NoSeriesMgt.SelectSeries(GLSetup."Bank Account Nos.", OldBankAcc."No. Series", BankAcc."No. Series") then begin
            GLSetup.Get();
            GLSetup.TestField("Bank Account Nos.");
            NoSeriesMgt.SetSeries(BankAcc."FD No.");
            Rec := BankAcc;
            exit(true);
        end;
    end;
    ...
    begin
        ...
        if not IsTemporary then begin
            DimMgt.SaveDefaultDim(DATABASE::"Bank Account", "FD No.", FieldNumber, ShortcutDimCode);
            Modify;
        end;
    ...
    begin
        ...
        ContBusRel.SetRange("No.", "FD No.");
        if not ContBusRel.FindFirst() then begin
            if not Confirm(Text003, false, TableCaption, "FD No.") then
                exit;
    ...
    begin
        ...
        BankAccount.SetFilter("No.", '<>%1', "FD No.");
    ...
    begin
        ...
        PaymentRegistrationSetup.SetRange("Bal. Account No.", "FD No.");
    ...
    begin
        ...
        if not UpdateNeeded and not IsTemporary then
            UpdateNeeded := BankContUpdate.ContactNameIsBlank("FD No.");
