report 50100 "Sales Commercial Invoice"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Sales Commercial Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layouts\SalesCommercialInvoice.rdl';
    ...
    var
        ...
        CommercialInvCapLbl: Label ' DRAFT COMMERCIAL INVOICE';
