report 50095 "Purchase Order Short close ame"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    DefaultLayout = RDLC;
    //RDLCLayout = 'Report\Layouts\PurchaseOrder - Copy.rdl';
    RDLCLayout = 'Report\Layouts\PurchaseOrder-ShortClose-Amendment.rdl';
    Caption = 'Purchase Order Short close Amendment';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                begin
                    ...
                    if PurchaseHeaderArchieveGrec.FindFirst() then begin
   ...
   GSTSetup: Record "GST Setup")
    ...
    var
        ...
        PurChaseOrderCapLbl: Label 'AMENDMENT OF PURCHASE ORDER';
        RemarksGvar: Text;
        ...
        POAcrhiveQty: Decimal;
        POArchiveDec: Text[100];
        POArchiveLocation: Code[10];
        POArchiveUON: Code[10];
        POArchiveGstCode: Code[20];
