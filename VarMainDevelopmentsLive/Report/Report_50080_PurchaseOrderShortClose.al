report 50080 "Purchase Order Short Close"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    DefaultLayout = RDLC;
    //RDLCLayout = 'Report\Layouts\PurchaseOrder - Copy.rdl';
    RDLCLayout = 'Report\Layouts\PurchaseOrderShortClose.rdl';
    Caption = 'Purchase Order-Short Close';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Payment Terms And Conditions"; "Payment Terms And Conditions")
            {
                ...
                begin
                    ...
                    AmendedDescription1 := 'ShortClose';
                    PurchaseHeaderArchieveGrec.Reset();
   ...
   GSTSetup: Record "GST Setup")
    ...
    var
        ...
        ArchievedDateCapLbl: Label 'ShortClose Date';
