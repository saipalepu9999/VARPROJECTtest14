report 50019 "Bank Receipt"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layouts\BankReceiptNew.rdl';
        ...
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            begin
                ...
                if "Applies-to ID" <> '' then begin
                    ...
                    BalAmt := LineAmount - (AdvanceAmount + "Gen. Journal Line".Amount + TDSAmt);
                end else begin
                    GetTDSAmount("Gen. Journal Line");
                    GetAdvanceAmount("Gen. Journal Line");
                    LineAmount := Amount;
                ...
                CheckGRec.FormatNoText(NumberText, Round(CreditAmt, 1, '='), "Currency Code");
                ...
                if "Applies-to ID" <> '' then
                    TotalLineAmountGvar += LineAmount + BankChargesGvar - TDSAmt;
                if "Applies-to ID" = '' then begin
