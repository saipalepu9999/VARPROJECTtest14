report 50014 "Domestic Invoice"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Domestic Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = 'New Report Layouts\DomesticInvoice1 - Copy.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    if "Sales Invoice Header"."Currency Factor" <> 0 then
                        AmountVendor += "Line Amount" / "Sales Invoice Header"."Currency Factor" + TCSAmountVar
                    else
            ...
            begin
                ...
                if StateLRec.get("Sales Invoice Header".State) then; //B2BSSD14NOV22
    ...
    var
        ...
        TaxInvCapLbl: Label 'TAX INVOICE';
