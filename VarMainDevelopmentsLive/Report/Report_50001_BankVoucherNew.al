report 50001 "BankVoucherNew"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layouts\BankVoucherNew2.rdl';
        ...
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            begin
                ...
                if "Applies-to ID" <> '' then begin
                    ...
                    BalAmt := LineAmount - (AdvanceAmount + "Gen. Journal Line".Amount + TdsAmtNew);
                end else begin
                    GetTDSAmount("Gen. Journal Line");
                    GetAdvanceAmount("Gen. Journal Line");
                    LineAmount := Amount;
                ...
                CheckGRec.FormatNoText(NumberText, Round("Credit Amount" + BankChargesGvar - TotalTdsAmt, 1, '='), "Currency Code");
