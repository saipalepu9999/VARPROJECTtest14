report 50102 "Export Draft Invoice B2B"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Export Tax Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layouts\ExportDraftInvoiceB2B.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    if "Sales Header"."Currency Factor" <> 0 then
                        AmountVendor += "Line Amount" / "Sales Header"."Currency Factor"
                    else
            ...
            begin
                ...
                SalesCommentLineGrec.SetRange("Document Type", SalesCommentLineGrec."Document Type"::Invoice);
    ...
    local procedure GetSalesGSTAmount(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line")
    var
        DetailedGSTLedgerEntry: Record "Detailed GST Ledger Entry";
    begin
        //Clear(IGSSTAmt);
    ...
    var
        ...
        ExportTaxInvCapLbl: Label 'DRAFT EXPORT INVOICE';
