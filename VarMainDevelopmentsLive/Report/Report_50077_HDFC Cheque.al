report 50077 "HDFC Cheque"
{
    // version CHQP1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layouts\HDFCReportNew.rdl';
    ...
    procedure GetValues(var Rec: Record 271; LineText1: Text[70]; LineText2: Text[70]; NewamountGvar: Decimal);
    var
        GLAccount: Record 15;
        Customer: Record 18;
        Vendor: Record 23;
        ...
        PurchRcptSubFm: Page "Purch. Invoice Subform";
    begin
