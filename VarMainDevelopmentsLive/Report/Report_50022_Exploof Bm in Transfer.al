report 50022 "Quant Explo of BOM In Transfer"//B2BSPON22SEPT12
{
            ...
            dataitem(BOMLoop; "Integer")
            {
                ...
                dataitem("Integer"; "Integer")
                {
                    ...
                    begin
                        ...
                        transferLine.Insert();
                        transferLine.Validate("Item No.", BomComponent[Level]."No.");
                        transferLine.Validate(Quantity, BOMQty);
                        transferLine.Modify();
                    end;
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(CalculateDate; format(CalculateDate, 0, '<Day,2>-<Month,2>-<Year4>'))
                    {
                        ApplicationArea = Manufacturing;
    ...
    procedure GetTrans(Trans: code[20])
    Begin
        TransferNo := Trans;
    End;
