report 50031 "Sales Register Export"

{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    ProcessingOnly = true;
    Caption = 'Sales Register (Export)';
    ...
    dataset
    {
        ...
        dataitem("Sales Invoice Line"; "Sales Invoice Line")
        {
            ...
            begin
                ...
                ExcelBuffer.AddColumn("Unit Price", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ExcelBuffer.AddColumn("Unit Price" * GetExchRate(SaleInvHdr."Currency Factor"), FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ExcelBuffer.AddColumn(Quantity * "Unit Price", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ExcelBuffer.AddColumn(Quantity * "Unit Price" * GetExchRate(SaleInvHdr."Currency Factor"), FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ...
                ExcelBuffer.AddColumn(TotalAmtTax / GetExchRate(SaleInvHdr."Currency Factor"), FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ExcelBuffer.AddColumn(TotalAmtTax, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ExcelBuffer.AddColumn(Quantity * "Unit Price" + TotalAmtTax / GetExchRate(SaleInvHdr."Currency Factor"), FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
                ExcelBuffer.AddColumn(Quantity * "Unit Price" * GetExchRate(SaleInvHdr."Currency Factor") + TotalAmtTax, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Number);
            end;
    ...
    begin
        ...
        ExcelBuffer.AddColumn('', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn('', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn(StrSubstNo('SALES REGISTER FOR THE YEAR %1-%2 (Export)', Date2DMY(Date1, 3), Date2DMY(Date2, 3)), FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.NewRow();
        ...
        ExcelBuffer.AddColumn('Gross Sales (LCY)', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuffer."Cell Type"::Text);
        ...
        ExcelBuffer.AddColumn('Total Amount of Tax (LCY)', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn('Total Invoice Amount', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn('Total Invoice Amount(LCY)', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuffer."Cell Type"::Text);
    end;

    LOCAL PROCEDURE CreateBook();
    BEGIN
        ExcelBuffer.CreateBookAndOpenExcel('', 'Sales Register Export', '', '', USERID);
    END;
    ...
    local procedure GetExchRate(CurrFactor: Decimal): Decimal
    var
        myInt: Integer;
    begin
